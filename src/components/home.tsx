            ...
            <Container>
                <Row>
                    ...
                    <Col>
                        ...
                        <Button className="button-style basic-quiz-button" style = {{fontSize: "45px"}} onClick={()=>{selectPage("Basic Questions")}}>Start Quiz</Button> <br/>
                        <div>
                            <p style={{fontSize: "24px", display:"inline"}}>Have some extra time to spend? Try out our </p>
                            <button className="link-button" style = {{fontSize: "24px"}} onClick={()=>{selectPage("Detailed Questions")}}>Detailed Quiz</button>
                        </div>
                    </Col>
                </Row>
            </Container>
