        ...
        <Container id="home">
            <Row>
                ...
                <Col md={12} lg={6} className="desc-container">
                    ...
                    <div>
                        <p style={{fontSize: "20px", display:"inline"}}>Already know what area you want to work in? Looking for more than just a broad-strokes assessment? Talk to an AI in our &#8203;
